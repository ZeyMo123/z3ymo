...
export async function generateMetadata({
  ...
  return {
    ...
    // ✓ excerpt is string | null — coerce null to undefined for metadata
...
export default async function GuideReadingPage({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
  ...
  // ✓ Fire-and-forget view increment — void, not .catch()
  ...
  return (
    <main className="min-h-screen bg-whisper dark:bg-void">
      ...
      {/* ✓ ReadingLayout receives individual props, not item={data} */}
      <ReadingLayout
        type="guide"
        title={data.title}
