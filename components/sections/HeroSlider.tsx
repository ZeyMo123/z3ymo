...
const SLIDES: SlideData[] = [
  {
    id: 'company',
    tag: 'Africa\'s premium tech company',
    tagColor: '#C0392B',
    headline: ['Built', 'different.', 'By design.'],
    headlineAccent: [2],
    sub: 'From Tanzania to the world — world-class software, AI agents, and digital products priced for African reality.',
  ...
  },
  {
    ...
    tagColor: '#1B998B',
    headline: ['AI-powered', 'apps.', 'Any screen.'],
    headlineAccent: [0, 2],
    sub: 'We build premium PWA web apps, mobile apps, and dashboards — optimised for performance on any device and connection speed.',
  ...
  {
    id: 'pulse',
    tag: 'Z3ymo Pulse · AI agents',
    tagColor: '#C9A84C',
    headline: ['Automate', 'your', 'business.'],
    headlineAccent: [0, 2],
    sub: 'Z3ymo Pulse is a WhatsApp AI agent for African businesses — handling customer support, bookings, and sales 24/7 in English and Swahili.',
    ctaPrimary: 'Join Pulse waitlist',
    ctaSecondary: 'Learn more',
    ctaSecondaryHref: '/ai-agents/pulse',
    accentColor: '#C9A84C',
  },
]
